...
(function() {
  var Test, appRouter, questionViews;
  ...
  Test.Views.Questions = Backbone.View.extend({
    ...
    addOne: function(model) {
      console.log("addOne");
      this.currentView = new Test.Views.Question({
        model: model
      });
  ...
  Test.Router = Backbone.Router.extend({
    ...
    defaultRoute: function() {
      ...
      Test.answers.fetch();
      questionViews = new Test.Views.Questions({
      ...
      $("#butAddItem").click(null, function(event) {
        var currentModel;
        if (typeof selectionVal !== "undefined" && selectionVal !== null) {
